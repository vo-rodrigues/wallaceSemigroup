...
In 1955, Wallace \cite{W} has asked if every countably compact two-sided cancellative semigroup is a topological group.
...
The first consistent example of such a semigroup, due to D. Robbie and S. Svetlichny, appeared forty-one years later in the Proceedings of the American Mathematical Society \cite{RS}, under the Continuum Hypothesis (CH).
